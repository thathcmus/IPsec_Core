...
// SystemVerilog created from i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc0
...
module camelliaCBC_i_llvm_fpga_ffwd_dest_s_stru0000ta40616_camelliacbc0 (
    ...
    wire [287:0] i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_data_in;
    wire [0:0] i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_in;
    wire i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_in_bitsignaltemp;
    wire [0:0] i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_in;
    wire i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_in_bitsignaltemp;
    wire [287:0] i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_data_out;
    wire [0:0] i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_out;
    wire i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_out_bitsignaltemp;
    wire [0:0] i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_out;
    wire i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_out_bitsignaltemp;
    ...
    // i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1(EXTIFACE,10)@1
    assign i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_data_in = dsdk_ip_adapt_bitjoin2_q;
    assign i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_in = in_stall_in;
    assign i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_in = in_valid_in;
    assign i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_in_bitsignaltemp = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_in[0];
    assign i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_in_bitsignaltemp = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_in[0];
    assign i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_out[0] = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_out_bitsignaltemp;
    assign i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_out[0] = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_out_bitsignaltemp;
    acl_ffwddst #(
        .MAX_LATENCY(0),
        .MIN_CAPACITY(0),
        .STALL_FREE(1),
        .WIDTH(288)
    ) thei_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1 (
        .data_in(dsdk_ip_adapt_bitjoin2_q),
        .stall_in(i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_in_bitsignaltemp),
        .valid_in(i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_in_bitsignaltemp),
        .data_out(i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_data_out),
        .stall_out(i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_out_bitsignaltemp),
        .valid_out(i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_out_bitsignaltemp),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    assign ip_dsdk_adapt_bitselect12_merged_bit_select_b = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_data_out[7:0];
    assign ip_dsdk_adapt_bitselect12_merged_bit_select_c = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_data_out[159:32];
    assign ip_dsdk_adapt_bitselect12_merged_bit_select_d = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_data_out[287:160];
    ...
    assign out_valid_out = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_valid_out;

    // sync_out(GPOUT,32)@1
    assign out_stall_out = i_llvm_fpga_ffwd_dest_s_struct_datastructs_inputdata40616_camelliacbc1_stall_out;
