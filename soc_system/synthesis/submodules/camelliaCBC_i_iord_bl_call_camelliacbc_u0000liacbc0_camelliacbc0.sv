...
// SystemVerilog created from i_iord_bl_call_camelliacbc_unnamed_camelliacbc0_camelliacbc0
...
module camelliaCBC_i_iord_bl_call_camelliacbc_u0000liacbc0_camelliacbc0 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_camelliaCBC_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_camelliaCBC_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_camelliaCBC_i_fifodata),
    ...
    assign ip_dsdk_adapt_bitselect26_b = iord_o_data[415:288];

    // ip_dsdk_adapt_bitselect36(BITSELECT,22)
    assign ip_dsdk_adapt_bitselect36_b = ip_dsdk_adapt_bitselect26_b[127:96];

    // ip_dsdk_adapt_bitselect34(BITSELECT,21)
    assign ip_dsdk_adapt_bitselect34_b = ip_dsdk_adapt_bitselect26_b[95:64];

    // ip_dsdk_adapt_bitselect32(BITSELECT,20)
    assign ip_dsdk_adapt_bitselect32_b = ip_dsdk_adapt_bitselect26_b[63:32];

    // ip_dsdk_adapt_bitselect30(BITSELECT,19)
    assign ip_dsdk_adapt_bitselect30_b = ip_dsdk_adapt_bitselect26_b[31:0];

    // ip_dsdk_adapt_bitselect2(BITSELECT,13)
    assign ip_dsdk_adapt_bitselect2_b = iord_o_data[287:0];

    // ip_dsdk_adapt_bitselect16(BITSELECT,11)
    assign ip_dsdk_adapt_bitselect16_b = ip_dsdk_adapt_bitselect2_b[287:160];

    // ip_dsdk_adapt_bitselect24(BITSELECT,16)
    assign ip_dsdk_adapt_bitselect24_b = ip_dsdk_adapt_bitselect16_b[127:96];

    // ip_dsdk_adapt_bitselect22(BITSELECT,15)
    assign ip_dsdk_adapt_bitselect22_b = ip_dsdk_adapt_bitselect16_b[95:64];

    // ip_dsdk_adapt_bitselect20(BITSELECT,14)
    assign ip_dsdk_adapt_bitselect20_b = ip_dsdk_adapt_bitselect16_b[63:32];

    // ip_dsdk_adapt_bitselect18(BITSELECT,12)
    assign ip_dsdk_adapt_bitselect18_b = ip_dsdk_adapt_bitselect16_b[31:0];

    // ip_dsdk_adapt_bitselect6(BITSELECT,24)
    assign ip_dsdk_adapt_bitselect6_b = ip_dsdk_adapt_bitselect2_b[159:32];
    ...
    assign ip_dsdk_adapt_bitselect4_b = ip_dsdk_adapt_bitselect2_b[7:0];
    ...
    assign out_o_data_9_tpl = ip_dsdk_adapt_bitselect30_b;
    assign out_o_data_10_tpl = ip_dsdk_adapt_bitselect32_b;
    assign out_o_data_11_tpl = ip_dsdk_adapt_bitselect34_b;
    assign out_o_data_12_tpl = ip_dsdk_adapt_bitselect36_b;
    assign out_o_valid = iord_o_valid;

    // dupName_0_regfree_osync_x(GPOUT,3)
    assign out_iord_bl_call_camelliaCBC_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,41)
    assign out_iord_bl_call_camelliaCBC_o_fifoalmost_full = iord_o_fifoalmost_full;
