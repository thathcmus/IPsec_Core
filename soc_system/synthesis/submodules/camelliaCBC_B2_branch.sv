...
// SystemVerilog created from camelliaCBC_B2_branch
...
module camelliaCBC_B2_branch (
    ...
    wire [0:0] camelliaCBC_B2_branch_enable_q;
    wire [0:0] camelliaCBC_B2_branch_enable_not_q;
    ...
    begin
        ...
        else if (camelliaCBC_B2_branch_enable_q == 1'b1)
        begin
    ...
    // camelliaCBC_B2_branch_enable(LOGICAL,3)
    assign camelliaCBC_B2_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // camelliaCBC_B2_branch_enable_not(LOGICAL,4)
    assign camelliaCBC_B2_branch_enable_not_q = ~ (camelliaCBC_B2_branch_enable_q);

    // out_stall_out(GPOUT,15)
    assign out_stall_out = camelliaCBC_B2_branch_enable_not_q;
