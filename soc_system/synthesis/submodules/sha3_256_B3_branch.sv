...
// SystemVerilog created from sha3_256_B3_branch
...
module sha3_256_B3_branch (
    ...
    wire [0:0] sha3_256_B3_branch_enable_q;
    wire [0:0] sha3_256_B3_branch_enable_not_q;
    ...
    begin
        ...
        else if (sha3_256_B3_branch_enable_q == 1'b1)
        begin
    ...
    // sha3_256_B3_branch_enable(LOGICAL,16)
    assign sha3_256_B3_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // sha3_256_B3_branch_enable_not(LOGICAL,17)
    assign sha3_256_B3_branch_enable_not_q = ~ (sha3_256_B3_branch_enable_q);

    // out_stall_out(GPOUT,13)
    assign out_stall_out = sha3_256_B3_branch_enable_not_q;
